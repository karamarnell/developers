...
```bash
$ curl -X POST http://qordoba:8001/consumers/{consumer}/basic-auth \
...
```bash
$ curl -X GET http://qordoba:8001/basic-auths
...
```bash
curl -X GET http://qordoba:8001/basic-auths/{username or id}/consumer
