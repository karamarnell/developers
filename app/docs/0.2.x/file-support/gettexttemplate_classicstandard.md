---
title: gettext template/classic standard
header&lowbar;icon: /assets/images/icons/icn-documentation.svg
header&lowbar;title: gettext template/classic standard
breadcrumbs:
  Files types list: /files
---
#gettext template/classic standard
...
- Content&lowbar;type API Endpoint: POT

**Gettext POT (PO template)**
